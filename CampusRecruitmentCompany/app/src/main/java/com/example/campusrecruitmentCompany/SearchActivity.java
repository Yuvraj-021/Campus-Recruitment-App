...
public class SearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref = FirebaseDatabase.getInstance().getReference().child("StudentResumeDetails");
    }
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        for (DataSnapshot ds : dataSnapshot.getChildren()) {
                            list.add(ds.getValue(StudentResumeDetails.class));
                        }
    ...
    private void search(String str) {
        ArrayList<StudentResumeDetails> mylist = new ArrayList<>();
        for (StudentResumeDetails object : list) {
            if (object.getStudname().contains(str) ||object.getLangknown().contains(str)) {
                mylist.add(object);
            }
